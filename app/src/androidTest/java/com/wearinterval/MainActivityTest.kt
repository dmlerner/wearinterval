...
class MainActivityTest {
  ...
  fun mainActivity_hiltAnnotationPresent() {
    ...
    val hiltAnnotations =
      activityClass.annotations.filter { it.annotationClass.simpleName == "AndroidEntryPoint" }
  ...
  fun mainActivity_inheritsFromComponentActivity() {
    ...
    // Then
    assertThat(androidx.activity.ComponentActivity::class.java.isAssignableFrom(activityClass))
      .isTrue()
  }
