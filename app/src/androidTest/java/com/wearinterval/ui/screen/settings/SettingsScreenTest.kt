...
class SettingsScreenTest {
  ...
  fun settingsButtonsAreDisplayed() {
    ...
    // Then
    composeTestRule.onNodeWithContentDescription("Toggle vibration").assertIsDisplayed()

    composeTestRule.onNodeWithContentDescription("Toggle sound").assertIsDisplayed()

    composeTestRule.onNodeWithContentDescription("Toggle auto mode").assertIsDisplayed()

    composeTestRule.onNodeWithContentDescription("Toggle screen flash").assertIsDisplayed()
  }
  ...
  fun vibrationButtonClickTriggersEvent() {
    ...
    // When
    composeTestRule.onNodeWithContentDescription("Toggle vibration").performClick()
  ...
  fun soundButtonClickTriggersEvent() {
    ...
    // When
    composeTestRule.onNodeWithContentDescription("Toggle sound").performClick()
  ...
  fun autoModeButtonClickTriggersEvent() {
    ...
    // When
    composeTestRule.onNodeWithContentDescription("Toggle auto mode").performClick()
  ...
  fun flashButtonClickTriggersEvent() {
    ...
    // When
    composeTestRule.onNodeWithContentDescription("Toggle screen flash").performClick()
