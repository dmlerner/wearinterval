...
class HistoryScreenTest {
  ...
  fun emptyStateDisplaysCorrectMessage() {
    ...
    // Then
    composeTestRule.onNodeWithText("No Recent\nConfigurations").assertIsDisplayed()
  ...
  fun configurationItemClickTriggersSelectEvent() {
    ...
    composeTestRule.onNodeWithContentDescription(firstConfigDescription).performClick()
  ...
  fun configurationWithZeroRestDisplaysCorrectly() {
    ...
    composeTestRule.onNodeWithContentDescription(configDescription).assertIsDisplayed()
  }
