...
/**
 * Compose UI tests for ProgressRing component visual rendering. Tests the actual composition and
 * rendering behavior.
 */
class ProgressRingComposeTest {
  ...
  fun progressRing_rendersWithCenterContent() {
    composeTestRule.setContent { TestProgressRing() }
  ...
  fun dualProgressRings_rendersWithCenterContent() {
    composeTestRule.setContent { TestDualProgressRings() }
