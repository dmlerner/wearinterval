...
/**
 * Unit tests for dependency injection module validation.
 * Integration tests for actual DI should be in androidTest directory.
 */
class ModuleValidationTest {
    ...
    fun databaseModule_providesExpectedTypes() {
        ...
        val expectedDatabaseTypes = setOf(
            "AppDatabase",
            "TimerConfigurationDao",
            "NotificationSettingsDao",
        )

        val actualTypes = setOf(
            "AppDatabase",
            "TimerConfigurationDao",
            "NotificationSettingsDao",
        )
    ...
    fun repositoryModule_providesExpectedTypes() {
        ...
        val expectedRepositoryTypes = setOf(
            "TimerRepository",
    ...
    fun dependency_injection_principles() {
        ...
        val repositoryAbstractions = listOf(
            "TimerRepository",
            "ConfigurationRepository",
            "SettingsRepository",
        )
    ...
    fun provider_methods_haveCorrectReturnTypes() {
        ...
        providerMethods.forEach { (methodName, returnType) ->
            ...
            val expectedKeyword = returnType.replace("Impl", "")
                .replace("DataStore<Preferences>", "DataStore")
                .lowercase()
