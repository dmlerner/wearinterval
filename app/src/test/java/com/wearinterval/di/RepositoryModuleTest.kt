...
class RepositoryModuleTest {
  ...
  fun repositoryModule_bindsCorrectTypes() {
    ...
    assertThat(SettingsRepositoryImpl::class.java.interfaces)
      .asList()
      .contains(SettingsRepository::class.java)
    assertThat(ConfigurationRepositoryImpl::class.java.interfaces)
      .asList()
      .contains(ConfigurationRepository::class.java)
    assertThat(TimerRepositoryImpl::class.java.interfaces)
      .asList()
      .contains(TimerRepository::class.java)
    assertThat(WearOsRepositoryImpl::class.java.interfaces)
      .asList()
  ...
  fun bindingMethods_haveCorrectAnnotations() {
    ...
    val bindSettingsRepositoryMethod =
      repositoryModuleClass.getDeclaredMethod(
    ...
    val bindConfigurationRepositoryMethod =
      repositoryModuleClass.getDeclaredMethod(
        "bindConfigurationRepository",
        ConfigurationRepositoryImpl::class.java,
      )
    assertThat(bindConfigurationRepositoryMethod.getAnnotation(dagger.Binds::class.java))
      .isNotNull()

    // Check bindTimerRepository method
    val bindTimerRepositoryMethod =
      repositoryModuleClass.getDeclaredMethod(
        "bindTimerRepository",
    ...
    val bindWearOsRepositoryMethod =
      repositoryModuleClass.getDeclaredMethod(
  ...
  fun allRepositoryImplementations_extendInterfaces() {
    ...
    assertThat(SettingsRepository::class.java.isAssignableFrom(SettingsRepositoryImpl::class.java))
      .isTrue()
    assertThat(
        ConfigurationRepository::class
          .java
          .isAssignableFrom(ConfigurationRepositoryImpl::class.java)
      )
      .isTrue()
    assertThat(TimerRepository::class.java.isAssignableFrom(TimerRepositoryImpl::class.java))
      .isTrue()
    assertThat(WearOsRepository::class.java.isAssignableFrom(WearOsRepositoryImpl::class.java))
      .isTrue()
  }
}
