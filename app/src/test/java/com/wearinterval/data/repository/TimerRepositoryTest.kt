...
class TimerRepositoryTest {
    ...
    private val runningState = TimerState(
    ...
    fun setup() {
        ...
        every { mockConfigurationRepository.currentConfiguration } returns MutableStateFlow(defaultConfig)
    ...
    fun `isServiceBound starts as false`() = runTest {
        repository.isServiceBound.test {
