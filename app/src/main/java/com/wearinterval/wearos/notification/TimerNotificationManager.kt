...
constructor(
  ...
  companion object {
    ...
    private val ALARM_PATTERN =
      longArrayOf(0, ALARM_VIBRATION_MS, 300, ALARM_VIBRATION_MS, 300, ALARM_VIBRATION_MS)
  }
  ...
  private fun triggerVibration(isAlarm: Boolean) {
    try {
      if (isAlarm) {
        ...
        vibrator.vibrate(
          VibrationEffect.createOneShot(SINGLE_VIBRATION_MS, VibrationEffect.DEFAULT_AMPLITUDE)
        )
      }
    } catch (e: Exception) {
